...
class UserService {
  ...
  static Future<ApiResponse<List<VipLevel>>> getVipLevels() async {
    try {
      ...
      return ApiResponse<List<VipLevel>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
              .map((e) => VipLevel.fromJson(e as Map<String, dynamic>))
              .toList();
        }
  ...
  static Future<ApiResponse<User>> getUserInfo() async {
    try {
      ...
      return ApiResponse<User>.fromJson(response.data, (json) {
  ...
  /// 修改个人信息
  /// 接口: /api/user/edit
  static Future<ApiResponse<void>> updateUserProfile(
  ...
  static Future<ApiResponse<void>> toggleGameFavorite(
    int gameId,
    int status,
  ) async {
    try {
  ...
  static Future<ApiResponse<void>> setPayPassword(
    String payPassword, {
    String? oldPayPassword,
  }) async {
    try {
      final data = {'pay_password': payPassword};
  ...
  static Future<ApiResponse<List<UserMessage>>> getUserMessages({
    int page = 1,
    int size = 20,
  }) async {
    try {
      ...
      return ApiResponse<List<UserMessage>>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic> &&
            json.containsKey('data') &&
            json['data'] is List) {
          return (json['data'] as List)
