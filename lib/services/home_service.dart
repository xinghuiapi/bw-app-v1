...
class HomeService {
  ...
  static Future<ApiResponse<List<GameCategory>>> getGameCategories() async {
    try {
      ...
      return ApiResponse<List<GameCategory>>.fromJson(
        response.data,
        (json) {
          if (json is List) {
            return json.map((e) => GameCategory.fromJson(e as Map<String, dynamic>)).toList();
          }
          return [];
        },
      );
  ...
  /// 参数: code (分类标识，如 live)
  static Future<ApiResponse<List<SubCategory>>> getGameListByCategory(String code) async {
    try {
  ...
  static Future<ApiResponse<List<ActivityClass>>> getActivityClass() async {
    try {
      ...
      return ApiResponse<List<ActivityClass>>.fromJson(
        response.data,
        (json) {
          if (json is List) {
            return json.map((e) => ActivityClass.fromJson(e as Map<String, dynamic>)).toList();
          }
          return [];
        },
      );
        ...
        (json) {
          if (json is List) {
           ...
           if (json is Map<String, dynamic> && json.containsKey('data') && json['data'] is List) {
            return (json['data'] as List).map((e) => Activity.fromJson(e as Map<String, dynamic>)).toList();
          }
          return [];
        },
      );
  ...
  static Future<ApiResponse<List<FeedbackType>>> getFeedbackTypes({String lang = 'CN'}) async {
    try {
      ...
      return ApiResponse<List<FeedbackType>>.fromJson(
        response.data,
        (json) {
          if (json is List) {
            return json.map((e) => FeedbackType.fromJson(e as Map<String, dynamic>)).toList();
          } else if (json is Map && json.containsKey('data')) {
            final dataList = json['data'];
            if (dataList is List) {
              return dataList.map((e) => FeedbackType.fromJson(e as Map<String, dynamic>)).toList();
            }
          }
          return [];
        },
  ...
  /// 提交问题反馈
  /// 接口: /api/feedback/to
  static Future<ApiResponse<void>> submitFeedback(int id, String text, {String? img, String lang = 'CN'}) async {
    try {
      final data = {
        'id': id,
        'text': text,
  ...
  /// 上传图片文件
  /// 接口: /api/img/save
  static Future<ApiResponse<String>> uploadImage(dynamic formData, {String lang = 'CN'}) async {
    try {
      final response = await api.post(
        '/img/save',
        data: formData,
        options: dioOptions(headers: {
  ...
  static Future<ApiResponse<List<SinglePageClass>>> getSingleClass() async {
    try {
      ...
      return ApiResponse<List<SinglePageClass>>.fromJson(
        response.data,
        (json) {
          if (json is List) {
            return json.map((e) => SinglePageClass.fromJson(e as Map<String, dynamic>)).toList();
          }
          return [];
        },
      );
  ...
  static Future<ApiResponse<SinglePageContent>> getSingleContent(int id) async {
    try {
      ...
      return ApiResponse<SinglePageContent>.fromJson(
        response.data,
        (json) {
           if (json is Map<String, dynamic> && json.containsKey('data')) {
            return SinglePageContent.fromJson(json['data'] as Map<String, dynamic>);
          }
