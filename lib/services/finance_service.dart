...
class FinanceService {
  ...
  static Future<ApiResponse<List<DepositCategory>>>
  getPrimaryCategories() async {
    try {
      final response = await api.post('/interface/class');

      return ApiResponse<List<DepositCategory>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
              .map((e) => DepositCategory.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        return [];
      });
  ...
  static Future<ApiResponse<List<TransferCategory>>> getTransferCategories(
    String code,
  ) async {
    try {
      final response = await api.post('/interface/list', data: {'code': code});

      return ApiResponse<List<TransferCategory>>.fromJson(response.data, (
        json,
      ) {
        if (json is List) {
          return json
              .map((e) => TransferCategory.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        return [];
      });
  ...
  static Future<ApiResponse<List<DepositChannel>>> getDepositChannels(
    int categoryId,
  ) async {
    try {
      ...
      return ApiResponse<List<DepositChannel>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
  ...
  static Future<ApiResponse<DepositOrderResponse>> submitRecharge(
    ...
    try {
      ...
      return ApiResponse<DepositOrderResponse>.fromJson(response.data, (json) {
  ...
  static Future<ApiResponse<RechargeDetail>> getRechargeDetails(
    int orderId,
  ) async {
    try {
      final response = await api.post(
      ...
      return ApiResponse<RechargeDetail>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic>) {
  ...
  static Future<ApiResponse<void>> cancelRecharge(
    int orderId, {
    String note = 'User Cancelled',
  }) async {
    try {
      final response = await api.post(
        '/recharge/cancel',
        data: {'id': orderId, 'note': note},
      );
  ...
  /// 上传充值凭证
  /// 接口: /api/recharge/img
  static Future<ApiResponse<void>> uploadRechargeImage(
    int orderId,
    String imgUrl,
  ) async {
    try {
  ...
  static Future<ApiResponse<List<PaymentMethod>>> getPaymentMethods() async {
    try {
      ...
      return ApiResponse<List<PaymentMethod>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
  ...
  static Future<ApiResponse<List<BankType>>> getBankTypes(int type) async {
    try {
      ...
      return ApiResponse<List<BankType>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
              .map((e) => BankType.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        return [];
      });
  ...
  static Future<ApiResponse<void>> bindPaymentMethod(
    BindPaymentRequest request,
  ) async {
    try {
      final response = await api.post(
        '/member_bank/binding',
  ...
  static Future<ApiResponse<void>> submitWithdraw(
  ...
  /// 获取交易记录
  /// 接口: /api/trade/record
  static Future<ApiResponse<List<TradeRecord>>> getTradeRecord(
    TradeRecordRequest request,
  ) async {
    try {
      final response = await api.post('/trade/record', data: request.toJson());

      return ApiResponse<List<TradeRecord>>.fromJson(response.data, (json) {
        // 假设分页数据在 data.data 中
        if (json is Map<String, dynamic> &&
  ...
  static Future<ApiResponse<List<TransferRecord>>> getTransferRecords({
    int page = 1,
    int size = 20,
  }) async {
    try {
      final response = await api.post(
        '/transfers_log/getlist',
        data: {'page': page, 'size': size},
      );

      return ApiResponse<List<TransferRecord>>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic> &&
            json.containsKey('data') &&
            json['data'] is List) {
          return (json['data'] as List)
  ...
  static Future<ApiResponse<List<RebateRecord>>> getRebateRecords({
    ...
    try {
      ...
      return ApiResponse<List<RebateRecord>>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic> &&
            json.containsKey('data') &&
            json['data'] is List) {
          return (json['data'] as List)
              .map((e) => RebateRecord.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        return [];
      });
  ...
  static Future<ApiResponse<List<MoneyLog>>> getMoneyLogList({
    ...
    try {
      ...
      return ApiResponse<List<MoneyLog>>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic> &&
            json.containsKey('data') &&
            json['data'] is List) {
          return (json['data'] as List)
              .map((e) => MoneyLog.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        return [];
      });
  ...
  static Future<ApiResponse<List<BettingRecord>>> getBettingRecords({
    ...
    try {
      ...
      return ApiResponse<List<BettingRecord>>.fromJson(response.data, (json) {
        if (json is Map<String, dynamic> &&
            json.containsKey('data') &&
            json['data'] is List) {
          return (json['data'] as List)
  ...
  static Future<ApiResponse<List<GameBalance>>> getGameBalance(
    dynamic id,
  ) async {
    try {
      final response = await api.post('/game/balance', data: {'id': id});

      return ApiResponse<List<GameBalance>>.fromJson(response.data, (json) {
        if (json is List) {
          return json
              .map((e) => GameBalance.fromJson(e as Map<String, dynamic>))
              .toList();
        }
        if (json is Map<String, dynamic>) {
  ...
  static Future<ApiResponse<void>> withdrawFromGame(
    int id,
    double money,
  ) async {
    try {
