...
import 'package:my_flutter_app/services/home/home_service.dart';

/// 活动分类提供者
final activityCategoriesProvider =
    FutureProvider.autoDispose<List<ActivityClass>>((ref) async {
...
final selectedActivityCategoryIdProvider =
    NotifierProvider.autoDispose<SelectedActivityCategoryId, int?>(
      SelectedActivityCategoryId.new,
    );

/// 活动列表提供者
final activityListProvider = FutureProvider.autoDispose
    .family<List<Activity>, int?>((ref, categoryId) async {
