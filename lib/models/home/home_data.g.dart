...
SubCategory _$SubCategoryFromJson(Map<String, dynamic> json) => SubCategory(
  ...
  gamecode: SubCategory._readGameCode(json, 'gamecode') as String?,
...
Activity _$ActivityFromJson(Map<String, dynamic> json) => Activity(
  ...
  title: json['title'] as String?,
  img: json['img'] as String?,
  appImg: json['app_img'] as String?,
  h5Img: json['h5_img'] as String?,
  pcImg: json['pc_img'] as String?,
  content: json['content'] as String?,
  startAt: Activity._readStartAt(json, 'start_at') as String?,
  endAt: Activity._readEndAt(json, 'end_at') as String?,
  status: (json['status'] as num?)?.toInt(),
);
...
Map<String, dynamic> _$ActivityToJson(Activity instance) => <String, dynamic>{
  ...
  'title': instance.title,
  'img': instance.img,
  'app_img': instance.appImg,
  'h5_img': instance.h5Img,
  'pc_img': instance.pcImg,
